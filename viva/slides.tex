		...
		\begin{exampleblock}{Reflection}
			...
			\begin{figure}[H]
				...
				\subfloat[Reflected wave\label{fg:wave_reflected}]{
					\resizebox{!}{2cm}{
						\input{../assets/viva/wave_reflected.tex}
					}
				}
			\end{figure}
		\end{exampleblock}
	...
	\begin{frame}{Use case: Beamforming}
		...
		\begin{figure}
			...
			\subfloat[Coverage extension]{
				\resizebox{!}{2.75cm}{
					\includegraphics{../assets/viva/ris_beamforming_coverage.pdf}
				}
			}
			\subfloat[Security enhancement]{
				\resizebox{!}{2.75cm}{
					\includegraphics{../assets/viva/ris_beamforming_security.pdf}
				}
			}
			\subfloat[Interference mitigation]{
				\resizebox{!}{2.75cm}{
					\includegraphics{../assets/viva/ris_beamforming_interference.pdf}
				}
			}
			\\
			\subfloat[Assist \glsfmtshort{d2d} network]{
				\resizebox{!}{2.75cm}{
					\includegraphics{../assets/viva/ris_beamforming_network.pdf}
				}
			}
			\subfloat[Assist information and power transfer]{
				\resizebox{!}{2.75cm}{
					\includegraphics{../assets/viva/ris_beamforming_swipt.pdf}
				}
			}
		\end{figure}
	\end{frame}
...
\begin{section}{Beamforming: \glsfmtshort{ris}-Aided \glsfmtshort{swipt}}
	...
	\begin{frame}{\glsfmtshort{wpt} via radio waves}
		...
		\begin{figure}[H]
			\centering
			\resizebox{\columnwidth}{!}{
				\input{../assets/viva/wpt_architecture.tex}
			}
			...
			\begin{figure}
				...
				\subfloat[\gls{ts} receiver]{
					\resizebox{0.48\columnwidth}{!}{
						\input{../assets/viva/receiver_ts.tex}
					}
					\label{fg:receiver_ts}
				}
				\subfloat[\gls{ps} receiver]{
					\resizebox{0.48\columnwidth}{!}{
						\input{../assets/viva/receiver_ps.tex}
					}
		...
		\begin{figure}[!t]
			...
			\subfloat{
				\resizebox{0.42\linewidth}{!}{
					\input{../assets/viva/receiver.tex}
				}
			}
			\subfloat{
