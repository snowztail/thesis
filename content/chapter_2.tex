...
\begin{section}{\glsfmtfull{wpt}}
	\begin{subsection}{Introduction}
		...
		Third and most importantly, radio waves carries power and information simultaneously such that \gls{wpt} can be jointly designed with \gls{wit} to make the most of radiation, spectrum and infrastructures.
		...
		We will discuss how \gls{ris} can help address these issues in Section \ref{sc:swipt}
	\end{subsection}
