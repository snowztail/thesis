...
\begin{section}{\glsfmtfull{bc}}
	...
	\begin{subsection}{Applications}
		...
		\begin{subsubsection}{\glsfmtfull{mbc}}
			...
			As shown in \subref*{fg:backcom_monostatic} and \subref*{fg:mbc_intro}, the interrogator transmits a \gls{cw} in the downlink and receives the reflected information-bearing signal in the uplink.
		...
		\begin{subsubsection}{\glsfmtfull{bbc}}
			\gls{bbc} separates the carrier emitter and reader into two individual devices, as illustrated in \subref*{fg:backcom_bistatic} and \subref*{fg:bbc_intro}.
		...
		\begin{subsubsection}{\glsfmtfull{ambc}}
			...
			As shown in \subref*{fg:ambc_intro}, it gets rid of dedicated \gls{rf} sources and relies on ambient signals (e.g., TV, FM, and Wi-Fi) for both energy harvesting and information transfer.
		...
		\begin{subsubsection}{\glsfmtfull{sr}}
			...
			As shown in \subref*{fg:sr_intro}, it shares not only the transmitter, \gls{rf} source, but also the receiver with a primary transmission.
