...
\begin{section}{Introduction}
	...
	\begin{figure}[!t]
		...
		\subfloat[\gls{ris}]{
			\resizebox{0.48\linewidth}{!}{
				\input{assets/chapter_2/ris.tex}
			}
			\label{fg:ris}
		}
		\subfloat[RIScatter]{
			\resizebox{0.48\linewidth}{!}{
				\input{assets/chapter_2/riscatter.tex}
			}
			\label{fg:riscatter}
		}
		\caption{
...
\begin{section}{RIScatter}
		...
		\begin{figure}[!t]
			...
			\subfloat[Input Distribution]{
				\resizebox{0.8\columnwidth}{!}{
					\input{assets/chapter_2/input_distribution.tex}
				}
			...
			\subfloat[Reflection Pattern]{
				\resizebox{0.8\columnwidth}{!}{
					\input{assets/chapter_2/time_structure.tex}
				}
	...
	\begin{subsection}{System Model}
		...
		\begin{figure}[!t]
			...
			\input{assets/chapter_2/riscatter_network.pdf_tex}
		...
		\begin{figure}[!t]
			\centering
			\resizebox{0.8\columnwidth}{!}{
				\input{assets/chapter_2/energy_distribution.tex}
			}
			\caption{
	...
	\begin{subsection}{Decision Threshold}
		...
		\begin{figure}[!t]
			...
			\resizebox{0.9\columnwidth}{!}{
				\input{assets/chapter_2/discrete_outputs.tex}
			}
...
\begin{section}{Simulation Results}
		...
		\begin{subsubsection}{Convergence}
			...
			\begin{figure}[!t]
				...
				\resizebox{0.75\columnwidth}{!}{
					\input{assets/chapter_2/wsr_convergence.tex}
				}
	...
	\begin{subsection}{Comparison of Scattering Applications}
		...
		\begin{figure}[!t]
			...
			\resizebox{0.65\columnwidth}{!}{
				\input{assets/chapter_2/region_comparison.tex}
			}
	...
	\begin{subsection}{Input Distribution under Different \glsfmtshort{qos}}
		\begin{figure}[!t]
			\centering
			\resizebox{0.65\columnwidth}{!}{
				\input{assets/chapter_2/distribution_weights.tex}
			}
		...
		\begin{figure}[!t]
			...
			\subfloat[Input Distribution, $Q=1$\label{fg:region_distribution}]{
				\resizebox{0.6\columnwidth}{!}{
					\input{assets/chapter_2/region_distribution.tex}
				}
			}
			\\
			\subfloat[Active Beamforming, $Q=4$\label{fg:region_beamforming}]{
				\resizebox{0.48\columnwidth}{!}{
					\input{assets/chapter_2/region_beamforming.tex}
				}
			}
			\subfloat[Decision Threshold, $Q=4$\label{fg:region_threshold}]{
				\resizebox{0.48\columnwidth}{!}{
					\input{assets/chapter_2/region_threshold.tex}
				}
			}
			\caption{
