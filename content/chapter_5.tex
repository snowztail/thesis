...
\begin{section}{Achievable Rate Maximization}\label{sc:rate}
	...
	% 			\input{assets/chapter_5/pc_rate_sx.tex}
	% 		}
	% 	}
	% 	\subfloat[Transmit Antenna, $N^\mathrm{S} = 256$\label{fg:pc_rate_tx}]{
	% 		\resizebox{0.48\columnwidth}{!}{
	% 			\input{assets/chapter_5/pc_rate_tx.tex}
	% 		}
	% 	}
...
\begin{section}{\glsfmtshort{mimo}-\glsfmtshort{ic}}
	...
	\begin{subsection}{Weighted Sum-Rate Maximization}
		...
		\end{equation}
		For a given $\mathbf{\Theta}$, \eqref{op:ic_rate} reduces to conventional linear beamforming problem, for which a closed-form iterative solution based on mutual information-\gls{mmse} relationship is proposed in \cite{Negro2010}.
...
\begin{section}{Conclusion}
	This chapter analyzes the channel shaping capability of \gls{ris} in terms of singular values redistribution.
