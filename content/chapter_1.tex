...
% 	The key contributions of Chapter \ref{ch:riscatter} are summarized as follows:
% 	\begin{itemize}
% 		\item Compare \gls{ris} with state-of-the-art \gls{bc} technologies and discuss the key properties of active and passive transmissions coexisting systems;
...
% 	The key contributions of Chapter \ref{ch:channel_shaping} are summarized as follows:
% 	\begin{itemize}
