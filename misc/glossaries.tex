...
\newacronym{bbc}{BBC}{Bistatic \glsdesc{bc}}
...
\newacronym{csit}{CSIT}{\glsdesc{csi} at the Transmitter}
...
\newacronym{mbc}{MBC}{Monostatic \glsdesc{bc}}
...
\newacronym{nlos}{NLoS}{Non-\glsdesc{los}}
...
\newacronym{rfid}{RFID}{\glsdesc{rf} Identification}
...
\nomenclature[o-u]{$\mathbb{A}(\cdot)$}{Extracts the \glsdesc{dc} component of a signal}
...
\nomenclature[r-b]{$\mathcal{CN}(\mathbf{0}, \mathbf{\Sigma})$}{Multivariate \glsdesc{cscg} with covariance $\mathbf{\Sigma}$}
